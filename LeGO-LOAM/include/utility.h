...
extern const string stateEstimatorTopic = "/state_estimator/pose_in_odom";
//extern const string imuTopic = "/sensors/imu"; // In ANYmal ros log
...
POINT_CLOUD_REGISTER_POINT_STRUCT (QuatPointXYZIT,
                                   (float, x, x) (float, y, y)
                                   (float, z, z) (float, intensity, intensity)
...
typedef QuatPointXYZIT  QuatPointTypePose;
